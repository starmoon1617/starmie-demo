<template>
    <v-layout>
        <v-container>
            <v-row>
                <v-col cols="1" sm="6" md="3"> <v-text-field v-model="searchForm.email" label="E-mail" outlined> </v-text-field> </v-col>
                <v-col cols="1" sm="6" md="3"> <v-text-field v-model="searchForm.name" label="名称" outlined> </v-text-field>
                </v-col>
            </v-row>
        </v-container>
    </v-layout>
    ...
    <v-layout>
        <v-container>
            <v-data-table :headers="tableDatas.headers" :items="tableDatas.dataItems"
                :server-items-length="tableDatas.total" class="elevation-1" :footer-props="footOptions"
                    ...
                    <v-toolbar flat color="white" height="1px">
                                    ...
                                    <v-container>
                                        ...
                                        <v-row>
                                            <v-col cols="1" sm="12" md="12">
                                                ...
                                                <template v-else>
                                                    <v-text-field v-model="editedItem.email" label="邮箱" outlined
                                        ...
                                        <v-row>
                                            <v-col cols="1" sm="12" md="12">
                                                <template v-if="editAble">
                                                    <v-text-field v-model="editedItem.loginName" label="登录名称"
                                                        outlined></v-text-field>
                                                </template>
                                                <template v-else>
                                                    <v-text-field v-model="editedItem.loginName" label="登录名称" outlined
                                                        readOnly="true"></v-text-field>
                                                </template>
                                            </v-col>
                                        </v-row>
                                        <v-row>
                                            <v-col cols="1" sm="12" md="12">
                                                ...
                                                <template v-else>
                                                    <v-text-field v-model="editedItem.name" label="名称" outlined
                                                        readOnly="true"></v-text-field>
                                                </template>
                                            </v-col>
                                        </v-row>
                                        <v-row>
                                            <v-col cols="1" sm="12" md="12">
                                                <template v-if="editAble">
                                                    <v-text-field v-model="editedItem.age" label="年龄"
                                                        outlined></v-text-field>
                                                </template>
                                                <template v-else>
                                                    <v-text-field v-model="editedItem.age" label="年龄" outlined
                                                        readOnly="true"></v-text-field>
                                                </template>
                                            </v-col>
                                        </v-row>
                                        <v-row>
                                            <v-col cols="1" sm="12" md="12">
                                                ...
                                                <template v-else>
                                                    <v-text-field v-model="editedItem.status" label="状态" outlined
                                                        readOnly="true"></v-text-field>
                                                </template>
                                            </v-col>
                                        </v-row>
                                        <v-row>
                                            <v-col cols="1" sm="12" md="12">
                                                ...
                                                <template v-else>
                                                    <v-text-field v-model="editedItem.remark" label="备注" outlined
                                                        readOnly="true"></v-text-field>
                                                </template>
                                            </v-col>
                                        </v-row>
                                        <v-row>
                                            <v-col cols="1" sm="12" md="12">
                                                <template v-if="editAble">
                                                    <v-text-field v-model="editedItem.createTime" label="创建时间"
                                                        outlined></v-text-field>
                                                </template>
                                                <template v-else>
                                                    <v-text-field v-model="editedItem.createTime" label="创建时间" outlined
                                                        readOnly="true"></v-text-field>
                                                </template>
                                            </v-col>
                                        </v-row>
                                        <v-row>
                                            <v-col cols="1" sm="12" md="12">
                                                <template v-if="editAble">
                                                    <v-text-field v-model="editedItem.createBy" label="创建用户"
                                                        outlined></v-text-field>
                                                </template>
                                                <template v-else>
                                                    <v-text-field v-model="editedItem.createBy" label="创建用户" outlined
                                                        readOnly="true"></v-text-field>
                                                </template>
                                            </v-col>
                                        </v-row>
                                        <v-row>
                                            <v-col cols="1" sm="12" md="12">
                                                ...
                                                <template v-else>
                                                    <v-text-field v-model="editedItem.updateTime" label="更新时间" outlined
                                                        readOnly="true"></v-text-field>
                                                </template>
                                            </v-col>
                                        </v-row>
                                        <v-row>
                                            <v-col cols="1" sm="12" md="12">
                                                <template v-if="editAble">
                                                    <v-text-field v-model="editedItem.updateBy" label="更新用户"
                                                        outlined></v-text-field>
                                                </template>
                                                <template v-else>
                                                    <v-text-field v-model="editedItem.updateBy" label="更新用户" outlined
                                                        readOnly="true"></v-text-field>
                                                </template>
                                            </v-col>
                                        </v-row>
                        ...
                        <v-dialog v-model="importDialog" max-width="500px">
                            <v-card>
                                ...
                                <v-card-text>
                                    <v-file-input id="importFile" placeholder="请选择要上传的文件" outlined
                                        v-model="importFile"></v-file-input>
                                </v-card-text>
                                <v-card-actions>
                                    <v-spacer></v-spacer>
...
export default {
        ...
        return {
            ...
            tableDatas: {
                headers: [
                    ...
                    { text: '邮箱', value: 'email', width: 100, sortable: false },
                    { text: '登录名称', value: 'loginName', width: 100, sortable: false },
                    { text: '名称', value: 'name', width: 100, sortable: false },
                    { text: '年龄', value: 'age', width: 100, sortable: false },
                    { text: '状态', value: 'status', width: 100, sortable: false },
    ...
    methods: {
        loadDatas() {
            let _this = this;
            common.searchDatas(/*[[@{/user/list}]]*/'/user/list', _this.searchForm, _this.pagination, function (response) {
        ...
        exportDatas() {
            let _this = this;
            common.exportDatas(/*[[@{/user/export}]]*/'/user/export', _this.searchForm, _this.exportFileName, _this.tableDatas.headers, function (error) {
                _this.confirmFormTitle = "失败";
                _this.confirmMsg = "异常:" + error;
                _this.confirmDialog = true;
            });
