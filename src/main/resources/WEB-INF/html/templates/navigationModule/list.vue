                            ...
                            <v-card>
                                ...
                                <v-card-text>
                                    ...
                                    <v-row>
                                        <v-col cols="1" sm="12" md="12">
                                            <template v-if="editAble">
                                                <v-text-field v-model="editedItem.moduleName" label="模块名称" outlined></v-text-field>
                                            </template>
                                            <template v-else>
                                                <v-text-field v-model="editedItem.moduleName" label="模块名称" outlined readOnly="true"></v-text-field>
                                            </template>
                                            </v-col>
                                    </v-row>
                                    <v-row>
    ...
    <script type="text/javascript" th:inline="javascript">
        new Vue({
                ...
                return {
                    ...
                    tableDatas: {
                        headers: [ 
                            ...
                            {text: '模块名称', value: 'moduleName', width:100, sortable: false}, 
                        ...
                        exportFileName : "NavigationModule导出"
                    }
                }
            },
            watch: {
            ...
            methods: {
                loadDatas() {
                    let _this = this;
                    common.searchDatas(/*[[@{/excel/list}]]*/'/navigation_module/list', _this.searchForm, _this.pagination, function(response){
                ...
                saveData(item) {
                    let _this = this;
                    let url = /*[[@{/navigation_module/save}]]*/'/navigation_module/save'; 
                    if (item.id) {
                        url = /*[[@{/navigation_module/update}]]*/'/navigation_module/update'; 
                    }
                ...
                deleteData(item) {
                    let _this = this;
                    common.updateData(/*[[@{/navigation_module/delete}]]*/'/navigation_module/delete', item, function(response){
                        let resp = response.data;
                        if(resp.success && resp.data) {
                            _this.confirmFormTitle = "成功";
                ...
                exportDatas() {
                    let _this = this;
                    common.exportDatas(/*[[@{/navigation_module/export}]]*/'/navigation_module/export', _this.searchForm, _this.exportFileName, _this.tableDatas.headers, function(error){
                        _this.confirmFormTitle = "失败";
                        _this.confirmMsg = "异常:" + error;
                        _this.confirmDialog = true;
                    });
                ...
                importDatas () {
                    let _this = this;
                    common.importDatas(/*[[@{/navigation_module/import}]]*/'/navigation_module/import', _this.importFile, 
                    "id,moduleNo,moduleName,createTime,createBy,updateTime,updateBy", 
                    function(response){
                        let resp = response.data;
                        if(resp.success && resp.data) {
                            _this.confirmFormTitle = "成功";
